namespace FakeItEasy.Auto.Build
{
    ...
    public class Program
    {
        ...
        {
            "FakeItEasy.Auto/FakeItEasy.Auto.csproj",
        };
        ...
        public static void Main(string[] args)
        {
            ...
            Target(
                "build",
                () => Run("dotnet", "build FakeItEasy.Auto.sln -c Release /maxcpucount /nr:false /verbosity:minimal /nologo /bl:artifacts/logs/build.binlog"));
